...
- **За 30 минут до начала:**
  «⏰ [%location%] Через 30 минут начинается ваша смена. Не забудьте открыть приложение.»
- **В момент начала (если не начата):**
  «🔴 [%location%] Ваша смена уже должна была начаться. Откройте приложение и начните выполнять задачи.»
- **Через 15 минут после начала (если не начата):**
  «🚨 [%location%] Вы опаздываете уже более 15 минут. Пожалуйста, откройте приложение.»
- **Через 30 минут после начала (если не начата):**
  «🚨🚨 [%location%] Смена не начата уже 30+ минут. Руководитель получил уведомление.»
